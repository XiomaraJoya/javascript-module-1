...
function satisfiesRequirements(htmlLevelAbove5) {
...
function satisfiesRequirements(cssLevelAbove5) {
  if (cssLevel  > 5) {
  return true;
}
return false;
...
function satisfiesRequirements(cssAndHtmlAbove5,cssOrHtmlAbove5) {
